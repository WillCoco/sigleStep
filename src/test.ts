...
import { getNormalPoints } from "./getMap";
const { resourceDir, inputDir } = require("./config.json");
...
// 测试斑点识别成功率
const option2 = new cv.SimpleBlobDetectorParams();
...
const points = cv.imread(path(resourceDir, 'grey_60.jpeg'));
getNormalPoints(option2)(points, '60.jpeg');
